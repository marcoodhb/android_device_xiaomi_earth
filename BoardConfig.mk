...
KERNEL_LLVM_BINUTILS := true
KERNEL_LD := LD=ld.lld
TARGET_KERNEL_ADDITIONAL_FLAGS := ARCH=arm64
TARGET_KERNEL_ADDITIONAL_FLAGS += SUBARCH=arm64
...
TARGET_KERNEL_ADDITIONAL_FLAGS += OBJSIZE=llvm-size
TARGET_KERNEL_ADDITIONAL_FLAGS += READELF=llvm-readelf
TARGET_KERNEL_ADDITIONAL_FLAGS += HOSTCC=clang
TARGET_KERNEL_ADDITIONAL_FLAGS += HOSTCXX=clang++
TARGET_KERNEL_ADDITIONAL_FLAGS += HOSTAR=llvm-ar
